...
import cv2
import numpy as np
face_cascade = cv2.CascadeClassifier('C:/Users/Irfan/Desktop/AI&DL/Computer vision/OpenCV_Datasets/Day 5/haarcascade_frontalface_alt.xml')
cap = cv2.VideoCapture(0)
scaling_factor = 0.5
while True:
    ret, frame = cap.read()
...
import numpy as np
face_cascade = cv2.CascadeClassifier('C:/Users/Irfan/Desktop/AI&DL/Computer vision/OpenCV_Datasets/Day 5/haarcascade_frontalface_alt.xml')
face_mask = cv2.imread('C:/Users/Irfan/Desktop/AI&DL/Computer vision/OpenCV_Datasets/Day 5/theatre mask black.png')
...
import numpy as np
face_cascade = cv2.CascadeClassifier('C:/Users/Irfan/Desktop/AI&DL/Computer vision/OpenCV_Datasets/Day 5/haarcascade_frontalface_alt.xml')
eye_cascade = cv2.CascadeClassifier('C:/Users/Irfan/Desktop/AI&DL/Computer vision/OpenCV_Datasets/Day 5/haarcascade_eye.xml')
if face_cascade.empty():
    raise IOError('Unable to load the face cascade classifier xml file')
...
import cv2
import numpy as np
cap = cv2.VideoCapture("C:/Users/Irfan/Desktop/AI&DL/Computer vision/OpenCV_Datasets/Day 5/Opencv_vehicle_detection.mp4")
cap.isOpened()
ret, image = cap.read()
while ret:
...
model = cv2.dnn.readNetFromCaffe('C:/Users/Irfan/Desktop/AI&DL/Computer vision/OpenCV_Datasets/Day 5/MobileNetSSD_deploy.prototxt',
                                 'C:/Users/Irfan/Desktop/AI&DL/Computer vision/OpenCV_Datasets/Day 5/MobileNetSSD_deploy.caffemodel')
...
frame = cv2.imread('C:/Users/Irfan/Desktop/AI&DL/Computer vision/OpenCV_Datasets/Day 5/people.jpg')
